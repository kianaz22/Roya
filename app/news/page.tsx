        ...
        <div className="container mx-auto px-8 md:px-16 relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-12">
              ...
              <a
                href="https://www.linkedin.com/company/roya-ecommerce"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-6 md:mt-0 inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium hover:shadow-lg transition-all duration-300"
              >
                {t('news.followUs')}
                <svg
